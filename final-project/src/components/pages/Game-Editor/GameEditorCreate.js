...
const GameEditorCreateForm = () => {
    ...
    const onFinish = (values) => {
      ...
      axios.post("https://backendexample.sanbersy.com/api/data-game", data,
      {headers: { Authorization: `Bearer ${header}` }}
      ).then((res) => {
        message.success("Your game has been added")
    ...
    return(
        <div>
            <h1>Add your new Game here</h1>
            <Form name="game-form" form={form} className="game-form" validateMessages
              onFinish={onFinish}
            >
            <Form.Item
                label="Name"
...
export default GameEditorCreateForm