...
const MovieEditorForm = () => {
    ...
    const param = params.idMovie
    useEffect(() => {
        axios.get(`https://backendexample.sanbersy.com/api/data-movie/${param}`)
        .then((res) => {
    ...
    const onFinish = (values) => {
      ...
      axios.put(`https://backendexample.sanbersy.com/api/data-movie/${param}`, data,
      {headers: { Authorization: `Bearer ${header}` }}
      ).then((res) => {
        message.success("Your movie has been updated")
    ...
    return(
        <div>
            <h1>Edit your new Movie here</h1>
